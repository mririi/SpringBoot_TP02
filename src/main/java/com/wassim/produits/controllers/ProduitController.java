package com.wassim.produits.controllers;
...
import com.wassim.produits.service.ProduitService;
@Controller
...
String msg ="produit enregistré avec Id"+saveProduit.getIdProduit(); modelMap.addAttribute("msg", msg);
return "createProduit";
}
...
produit, @RequestParam("date") String
date,ModelMap modelMap) throws ParseException {
//conversion de la date
